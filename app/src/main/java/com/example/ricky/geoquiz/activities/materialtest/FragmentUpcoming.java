...
public class FragmentUpcoming extends Fragment {
    ...
    public List<Information> getData() {
        ...
        int[] icons = {R.drawable.uhhtabb, R.drawable.button_notpressed, R.drawable.haterade, R.drawable.ic_number4};
        String[] titles = {"Hey", "Yeah", "Yeah", "Yeah"};
        for (int i = 0; i < 16; i++) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        listUpcoming.setAdapter(mAdapter);
